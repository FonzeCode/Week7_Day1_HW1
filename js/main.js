...
// String can be created using '', "", or ``, the tick marks(``) have a special
...
var newArray = ['Brian', 'Michael', 'Daniell', 'Frank']
...
// When accessing properties in an array (aka the indicdes),
console.log(person.languages[0])
console.log(person.languages[1])

// All Array object also have a "lenght" property
